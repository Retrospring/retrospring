...
#   attr_accessor :login
  ...
  validates :profile_picture, image_ratio: { height: :crop_h, width: :crop_w, ratio: 500 / 500, fix: true }, on: :update
  ...
  validates :profile_header, image_ratio: { height: :crop_h_h, width: :crop_h_w, ratio: 1500 / 350, throttle: 0.3, fix: true }, on: :update
